...
public:
	...
	enum {GENERIC_SYNCH_NEW,GENERIC_SYNCH_SMALL, GENERIC_SYNCH_MID,GENERIC_SYNCH_LARGE,GENERIC_IND_NEW, GENERIC_IND_SMALL, GENERIC_IND_MID, GENERIC_IND_LARGE, USER_DEFINED, VESTAS_V82, GE_25MW, BERGEY_10kW};
	enumeration Turbine_Model;
	enum {GENERAL_NEW,GENERAL_LARGE, GENERAL_MID,GENERAL_SMALL,MANUF_TABLE, CALCULATED, USER_SPECIFY};
	enumeration CP_Data;
