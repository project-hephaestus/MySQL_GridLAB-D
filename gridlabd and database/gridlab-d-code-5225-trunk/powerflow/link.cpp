...
using namespace std;
// Connection details
//string server4   = "tcp://10.96.12.53:3306";
//string username4 = "lamprini";
//string password4 = "12345"; // 

string server4   = "tcp://127.0.0.1:3306";
string username4 = "root";
string password4 = "test"; // 
...
if(gl_object_isa(obj,"transformer"))
{
...
{
				int16 *central=gl_get_int16_by_name(obj,"central");
					if(*central==1)
					{
							...
							//Here is the connection
								...
								connection = driver->connect(server4, username4, password4);
...
sprintf(Query, "INSERT INTO transformer(timestamp,power_in_A_real,power_in_B_real,power_in_C_real,power_out_A_real,power_out_B_real,power_out_C_real,power_in_A_imag,power_in_B_imag,power_in_C_imag,power_out_A_imag,power_out_B_imag,power_out_C_imag,power_losses_A_real,power_losses_A_imag) VALUES ('%s',%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f)",timenext_run,indiv_power_in[0].Re(),indiv_power_in[1].Re(),indiv_power_in[2].Re(),indiv_power_out[0].Re(),indiv_power_out[1].Re(),indiv_power_out[2].Re(),indiv_power_in[0].Im(),indiv_power_in[1].Im(),indiv_power_in[2].Im(),indiv_power_out[0].Im(),indiv_power_out[1].Im(),indiv_power_out[2].Im(),indiv_power_loss[0].Re(),indiv_power_loss[0].Im());
								printf("%s",Query);
